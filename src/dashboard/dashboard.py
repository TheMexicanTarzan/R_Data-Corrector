...
def main():
    """Main function to run the dashboard with dummy data."""

    print("Generating dummy financial data...")

    # Generate dummy data for 3 tickers
    ...
    for ticker in tickers:
        ...
        for category, log_data in logs.items():
            if log_data:  # Only add if not empty
    ...
    print("\nDashboard ready! Opening at http://localhost:8050")
